function PhotoWall() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    id: "vie",
    "data-screen-label": "Vie d'église",
    className: "sec-light relative bg-ink-800 py-20 md:py-28"
  }, /*#__PURE__*/React.createElement("div", {
    className: "max-w-[1480px] mx-auto px-6 sm:px-10 lg:px-14"
  }, /*#__PURE__*/React.createElement(Reveal, {
    className: "flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Eyebrow, {
    className: "mb-5"
  }, "La vie de l'église"), /*#__PURE__*/React.createElement(Heading, null, "Une famille,", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("em", {
    className: "italic text-gold-200 font-light"
  }, "tellement plus qu'une église."))), /*#__PURE__*/React.createElement("p", {
    className: "max-w-md text-[15px] text-bone-300 leading-relaxed"
  }, "Des moments vécus ensemble dimanche après dimanche, vendredi après vendredi — voici un aperçu de notre vie commune à Ngiri-Ngiri.")), /*#__PURE__*/React.createElement(Reveal, {
    stagger: true,
    ...
    className: "absolute inset-0 z-10 opacity-0 group-hover:opacity-100 transition",
    style: {
      background: "linear-gradient(180deg, transparent 35%, rgba(0,0,0,.85) 100%)"
    }
  }), /*#__PURE__*/React.createElement("div", {
    className: "absolute bottom-0 left-0 right-0 z-10 p-4 sm:p-5 translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition"
  }, /*#__PURE__*/React.createElement("div", {
    className: "font-mono text-[9px] tracking-[.22em] uppercase text-gold-300 mb-1"
  }, t.tag), /*#__PURE__*/React.createElement("div", {
    className: "font-display text-[18px] sm:text-[22px] leading-tight text-white"
  ...
  }, "Suivez-nous"), /*#__PURE__*/React.createElement(Btn, {
    variant: "ghost",
