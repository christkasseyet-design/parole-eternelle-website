...
function sbAnswer(q) {
  ...
  if (SB_REPORT_KEYS.some(k => n.includes(sbNorm(k)))) {
    return {
      type: "rapport",
      text: "Merci de nous le signaler 🙏 Votre message est enregistré dans le journal de cette page pour l'équipe du site. Pour que ce soit traité rapidement, envoyez-le aussi par WhatsApp avec le bouton ci-dessous — précisez si possible la page concernée et votre téléphone."
    };
  }
  if (SB_IDEA_KEYS.some(k => n.includes(sbNorm(k)))) {
    return {
      type: "idee",
      text: "Merci pour cette proposition 🙏 Elle est enregistrée pour l'équipe du site. Vous pouvez aussi l'envoyer par WhatsApp avec le bouton ci-dessous pour qu'elle soit étudiée plus vite."
    };
  }
  let best = null,
    score = 0;
  ...
  return {
    type: "inconnu",
    text: "Je n'ai pas la réponse à cette question précise. Écrivez-nous directement — par WhatsApp avec le bouton ci-dessous, via la section « Contact », ou sur notre page Facebook « cepeng ». Quelqu'un de l'équipe vous répondra."
  };
}
function sbLoad() {
  try {
...
function sbSave(entries) {
  try {
    localStorage.setItem(SB_KEY, JSON.stringify(entries.slice(-300)));
  } catch (e) {}
}
function SupportBot() {
  ...
  const [msgs, setMsgs] = React.useState([{
    role: "assistant",
    content: "Bonjour et bienvenue 🙏 Je suis Ange, l'aide de ce site. Posez-moi une question sur les cultes, le Jubilé, les dons ou les ministères — ou signalez-moi un souci sur le site."
  }]);
  ...
  const download = () => {
    ...
    const url = URL.createObjectURL(new Blob([body || "journal vide"], {
      type: "text/plain;charset=utf-8"
    }));
    const a = document.createElement("a");
    a.href = url;
    a.download = "assistance-parole-eternelle.txt";
    a.click();
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-display text-[15px] text-bone-50 leading-none"
  }, "Ange · Aide du site"), /*#__PURE__*/React.createElement("div", {
    className: "font-mono text-[9px] tracking-[.2em] uppercase text-gold-300 mt-1.5"
  }, "Réponses rapides · signalements"))), /*#__PURE__*/React.createElement("button", {
    onClick: () => setOpen(false),
    "aria-label": "Fermer",
    className: "w-8 h-8 rounded-full border border-white/15 text-bone-200 grid place-items-center hover:bg-white/10 transition"
    ...
    className: "sb-tabs"
  }, [["chat", "Conversation"], ["log", `Journal (${log.length})`]].map(([k, l]) => /*#__PURE__*/React.createElement("button", {
    key: k,
    onClick: () => setTab(k),
    className: `sb-tab ${tab === k ? "is-on" : ""}`
  }, l))), tab === "chat" ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "sb-body",
    ref: listRef
  }, msgs.map((m, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    className: `sb-msg ${m.role === "user" ? "sb-me" : "sb-ai"}`
  }, m.content, m.wa && /*#__PURE__*/React.createElement("a", {
    className: "sb-wa",
    href: `${WA}?text=${encodeURIComponent("Bonjour, message depuis le site Parole Éternelle :\n\n" + m.wa)}`,
    target: "_blank",
    rel: "noopener"
  }, "Envoyer par WhatsApp"))), busy && /*#__PURE__*/React.createElement("div", {
    className: "sb-msg sb-ai sb-typing"
  ...
  }, "Aucun message enregistré pour l'instant."), log.slice().reverse().map((e, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    className: "sb-logitem"
  }, /*#__PURE__*/React.createElement("div", {
    className: "font-mono text-[9px] tracking-[.16em] uppercase text-gold-300/80"
  }, e.role, " · ", new Date(e.at).toLocaleString("fr-FR")), /*#__PURE__*/React.createElement("div", {
    className: "text-[13px] text-bone-100 mt-1 leading-snug"
  }, e.content)))), /*#__PURE__*/React.createElement("div", {
    className: "sb-quick"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: download
  }, "Télécharger le journal"), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
    ...
    d: "M21 12a8 8 0 0 1-11.6 7.1L4 20.5l1.5-4.6A8 8 0 1 1 21 12z"
  })), /*#__PURE__*/React.createElement("span", {
